...
package com.xindany.tao_fen_ny.scan.camera;
...
import com.xindany.tao_fen_ny.scan.main.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        ...
        reverseImage = prefs.getBoolean(CameraManager.KEY_REVERSE_IMAGE, false);
    }
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.x - height) / 6;
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
