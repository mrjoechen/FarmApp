...
import com.edmodo.cropper.view.CropImageView;
...
//                croppedImageView.setImageBitmap(croppedImage);
                ...
                int [] r = cropImageView.getCroppedCoordinate();
            
                
                int y_begin = (int)(((double)r[3] / (double)r[1]) * 100);
                int y_end = (int)(((double)r[3] + (double)r[5]) / (double)r[1] * 100);
            
                
                
                Intent intent = new Intent();
                intent.putExtra("y_begin", y_begin);
                intent.putExtra("y_end", y_end);
                setResult(RESULT_OK, intent);
                //关闭当前activity
                finish();
                
            
//                Toast.makeText(SelectAreaActivity.this, "width:" + r[0] +", height:" + r[1] + ", cropX:" + r[2] + 
//                        ", cropY:"+ r[3] + ",cropWidth:"+r[4]+", cropHeight:"+r[5],
