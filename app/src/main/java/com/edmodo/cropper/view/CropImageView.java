...
package com.edmodo.cropper.view;
...
public class CropImageView extends ImageView {
    ...
    public int[] getCroppedCoordinate() {
        ...
        result[0] = (int)originalBitmap.getWidth();
        result[1] = (int)originalBitmap.getHeight();
        result[2] = (int)cropX;
        result[3] = (int)cropY;
        result[4] = (int)cropWidth;
        result[5] = (int)cropHeight;
